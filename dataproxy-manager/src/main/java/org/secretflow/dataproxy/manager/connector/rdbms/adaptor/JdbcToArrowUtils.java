...
import org.secretflow.dataproxy.manager.connector.rdbms.adaptor.consumer.*;
...
public class JdbcToArrowUtils {
     ...
     * </p>
     * <p>
     * If any columns are of type {@link Types#ARRAY}, the configuration object will be used to look up
     ...
     * @return {@link Schema}
     * @throws SQLException             on error
     * @throws IllegalArgumentException if <code>rsmd</code> contains an {@link Types#ARRAY} but the
