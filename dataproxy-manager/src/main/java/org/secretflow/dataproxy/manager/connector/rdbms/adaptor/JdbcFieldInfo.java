...
package org.secretflow.dataproxy.manager.connector.rdbms.adaptor;
 ...
 * Currently, this is:
 * <ul>
 *   <li>The JDBC {@link Types} type.</li>
 *   <li>The nullability.</li>
 *   <li>The field's precision (used for {@link Types#DECIMAL} and {@link Types#NUMERIC} types).</li>
 *   <li>The field's scale (used for {@link Types#DECIMAL} and {@link Types#NUMERIC} types).</li>
 * </ul>
 */
public class JdbcFieldInfo {
    ...
    /**
     * Builds a <code>JdbcFieldInfo</code> using only the {@link Types} type.  Do not use this constructor
     * if the field type is {@link Types#DECIMAL} or {@link Types#NUMERIC}; the precision and
     * scale will be set to <code>0</code>.
     *
     * @param jdbcType The {@link Types} type.
     * @throws IllegalArgumentException if jdbcType is {@link Types#DECIMAL} or {@link Types#NUMERIC}.
     */
    ...
    /**
     * Builds a <code>JdbcFieldInfo</code> from the {@link Types} type, precision, and scale.
     * Use this constructor for {@link Types#DECIMAL} and {@link Types#NUMERIC} types.
     *
     * @param jdbcType  The {@link Types} type.
    ...
    /**
     * Builds a <code>JdbcFieldInfo</code> from the {@link Types} type, nullability, precision, and scale.
     *
     * @param jdbcType    The {@link Types} type.
    ...
    /**
     * Builds a <code>JdbcFieldInfo</code> from the corresponding {@link ResultSetMetaData} column.
     *
     * @param rsmd   The {@link ResultSetMetaData} to get the field information from.
    ...
    /**
     * The numeric precision, for {@link Types#NUMERIC}  and {@link Types#DECIMAL} types.
     */
    ...
    /**
     * The numeric scale, for {@link Types#NUMERIC}  and {@link Types#DECIMAL} types.
     */
    public int getScale() {
        return scale;
    }
