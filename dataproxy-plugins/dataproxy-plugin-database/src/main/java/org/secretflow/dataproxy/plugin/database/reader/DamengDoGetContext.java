...
@Slf4j
public class DamengDoGetContext extends AbstractDatabaseDoGetContext{
    public DamengDoGetContext(DatabaseCommandConfig<?> config, Function<DatabaseConnectConfig, Connection> initDatabase) {
