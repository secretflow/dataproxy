...
public class HiveIntegrationTest extends BaseArrowFlightServerTest {

    private final Domaindatasource.DatabaseDataSourceInfo hiveDataSourceInfo =
            Domaindatasource.DatabaseDataSourceInfo
                    .newBuilder()
                    .setEndpoint(HiveTestUtil.getHiveEndpoint())
                    .setDatabase(HiveTestUtil.getHiveDatabase())
                    .build();
    ...
    static public void startServer() {
        ...
        assertNotEquals("", HiveTestUtil.getHiveEndpoint(), "hive endpoint is empty");
