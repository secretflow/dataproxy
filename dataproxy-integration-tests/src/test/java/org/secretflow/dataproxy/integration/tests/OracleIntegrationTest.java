...
import org.secretflow.dataproxy.integration.tests.utils.OracleTestUtil;
...
public class OracleIntegrationTest extends BaseArrowFlightServerTest {

    private final Domaindatasource.DatabaseDataSourceInfo oracleDataSourceInfo =
            Domaindatasource.DatabaseDataSourceInfo
                    .newBuilder()
                    .setEndpoint(OracleTestUtil.getOracleEndpoint())
                    .setDatabase(OracleTestUtil.getOracleDatabase())
                    .setUser(OracleTestUtil.getUser())
                    .setPassword(OracleTestUtil.getPassword())
                    .build();
    private final Domaindatasource.DataSourceInfo dataSourceInfo =
            Domaindatasource.DataSourceInfo.newBuilder().setDatabase(oracleDataSourceInfo).build();
    ...
    static public void startServer() {
        ...
        assertNotEquals("", DamengTestUtil.getDamengEndpoint(), "dameng endpoint is empty");
