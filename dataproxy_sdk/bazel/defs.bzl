...
def _dataproxy_copts():
    return select({
        "@dataproxy//dataproxy_sdk/bazel:dataproxy_build_as_release": RELEASE_FLAGS,
        "@dataproxy//dataproxy_sdk/bazel:dataproxy_build_as_debug": DEBUG_FLAGS,
        "@dataproxy//dataproxy_sdk/bazel:dataproxy_build_as_fast": FAST_FLAGS,
        "//conditions:default": FAST_FLAGS,
    }) + WARNING_FLAGS

def dataproxy_cmake_external(**attrs):
